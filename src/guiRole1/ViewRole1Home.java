...
public class ViewRole1Home {
	...
	private ViewRole1Home() {
		...
		// New
		setupButtonUI(button_Discussion, "Dialog", 18, 250, Pos.CENTER, 20, 110);
		button_Discussion.setOnAction(e -> ControllerRole1Home.openStudentDiscussion());
		...
		// Place all of the widget items into the Root Pane's list of children
         theRootPane.getChildren().addAll(
	        ...
	        button_Discussion, line_Separator4, button_Logout, button_Quit);
}
