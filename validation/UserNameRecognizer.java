	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						...
						//(currentChar >= '0' && currentChar <= '9' )) {	// Check for 0-9. Comment this out
				{
					nextState = 1;
			...
			case 1: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						(currentChar >= 'a' && currentChar <= 'z' ) ||	// Check for a-z
						(currentChar >= '0' && currentChar <= '9' )) 	// Check for 0-9 (Comment this out so the first char isn't a number
					{
					nextState = 1;
				...
				// "." "-" "_" -> State 2
				else if ((currentChar == '.') || (currentChar == '-') || (currentChar == '_')) { //just add more whats allowed  // Check for /
					nextState = 2;
		...
		case 1:
			...
			if (userNameSize < 4) {
				...
				userNameRecognizerErrorMessage += 
					"A UserName character may only contain the characters A-Z, a-z, 0-9, '-', '_' and '.'.\n";
				return userNameRecognizerErrorMessage;
			}
			else {
					// UserName is valid
		...
		case 2:
			...
			userNameRecognizerErrorMessage +=
				"A UserName character after a period, hyphen or an underscore must be A-Z, a-z, 0-9.\n";
			return userNameRecognizerErrorMessage;
